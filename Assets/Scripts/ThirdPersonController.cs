...
namespace StarterAssets
{
	...
	public class ThirdPersonController : MonoBehaviour
	{
		...
		[Space(10)]
		[Header("Dodge Roll Controllers")]
		[SerializeField] AnimationCurve _dodgeCurve;
		//bool to know if you're dodging
		private bool _isDodging;
		//timer to controll dodge time
		public float _dodgeTimer;
		...
		private void Move()
		{
            ...
            //set targetSpeed to MoveSpeed in case of aiming
            if (_input.aim)
            {
		...
		private IEnumerator Dodge()
        {
			...
			//change the collider size during the dodge
